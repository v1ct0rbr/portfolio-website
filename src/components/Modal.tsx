...
import { Modal, ModalContent, ModalHeader, ModalBody, ModalFooter, Button, useDisclosure, UseDisclosureProps } from "@nextui-org/react";


export default function App(props: UseDisclosureProps) {
    const { isOpen, onOpen, onOpenChange, onClose } = useDisclosure(props);
    ...
    return (
        <>
            ...
            <Modal isOpen={isOpen}
                onOpenChange={onOpenChange} isDismissable={true} size="5xl" placement="top-center" scrollBehavior="inside" >
                <ModalContent>

                    <ModalHeader className="flex flex-col gap-1">Política de Cookies</ModalHeader>
                    <ModalBody>

                        <p>Esta Política de Cookies destina-se a explicar como o nosso site utiliza cookies e tecnologias similares.
                        ...
                        <p>Ao acessar nosso site , poderemos utilizar cookies para os seguintes fins:</p>
                        <ol>
                        ...
                        <p>Ao utilizar nosso site, você concorda com o uso de cookies, conforme descrito nesta Política de
                            Cookies.
                        ...
                        <p>Se tiver alguma dúvida ou preocupação em relação ao uso de cookies em nosso site, entre em contato
                            conosco através dos meios de contato fornecidos no site.</p>

                        <p>Data da última atualização: [Inserir data da última atualização da política de cookies]</p>
                    </ModalBody>
                    <ModalFooter>
