...
export { initialState as CookiesInitialState, init as InitCookieFuntion, countAcceptedLocalData, changeLocalDataValue, getElementById as getElementFunction, addEventListenerToList, enableDisableAll, checkUncheckAll }